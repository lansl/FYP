...
public class UrlPhp_Database {
    public final static String login_URL = "https://unbloodied-heat.000webhostapp.com/connect/login.php";
    public final static String insertURL = "https://unbloodied-heat.000webhostapp.com/connect/insert.php";
